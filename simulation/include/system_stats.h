...
void print_system_stats(spine_t * spines, tor_t * tors, int64_t bytes, int64_t pkts, int64_t ns, int64_t cache_misses, int64_t cache_hits, float avg_delay_at_spine, float timeslot_len);
