...
#define SPINE_PORT_BUFFER_LEN (3 * NODES_PER_RACK)
#define TOR_UPSTREAM_BUFFER_LEN (100 * NODES_PER_RACK)
#define TOR_DOWNSTREAM_BUFFER_LEN (100 * NODES_PER_RACK)

#define LINK_CAPACITY 4096

#define MAX_FLOW_ID 1024
#define RTABLE_SIZE MAX_FLOW_ID
#define ECN_CUTOFF_TOR_UP 1024
#define ECN_CUTOFF_TOR_DOWN 1024
