...
#define TOR_PULL_QUEUE_LEN (2 * NUM_OF_SPINES)
#define TOR_NOTIFICATION_QUEUE_LEN (2 * NODES_PER_RACK)

#define RECVD_PULL_REQ_QUEUE_LEN (2 * OVERSUBSCRIPTION * TOR_PULL_QUEUE_LEN)
